...
from .utils import find_first_sentence, find_response_address, find_response_wikipedia, find_another_question
...
def index():
    ...
    return render_template('home.html', first_sentence=first_sentence, GOOGLE_MAP_KEY=GOOGLE_MAP_KEY)
